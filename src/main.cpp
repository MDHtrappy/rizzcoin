...
uint256 hashGenesisBlock("0x1dbdcd2e39899aae32a53c3cdd20d4217576b28031923884be7e06975a68e217");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Rizzcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Rizzcoin Signed Message:\n";
...
{
    // Rizzcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Rizzcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Rizzcoin: 3.5 days
static const int64 nTargetSpacing = 100; // Rizzcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Rizzcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Rizzcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Rizzcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x45bf0d30469cee4a0c7e8dd6cd3d3fa92eb4d83554d3f428aaf58423e1b5093e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("c7b1baa8fa8a2b1777418d4e99a1bd7cd9ec30fbcf3be61cd95e7c7e057d449b84b790dcb614ce2bea0406781bb4355302889467b25ecc174d90da659d1b0ba7db") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1715860611;
        block.nBits    = 504365644;
        block.nNonce   = 58815778;

        if (fTestNet)
        {
            block.nTime    = 1715860611;
            block.nNonce   = 3771345742;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xef822032c7c9b66846a911cfca733b19ea2ce82478241d36a629ce1686f88e7a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Rizzcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RizzcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RizzcoinMiner : ProcessBlock, block not accepted");
    }
